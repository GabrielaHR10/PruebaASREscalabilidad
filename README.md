...
| `informe/` | `informe_experimento.pdf` — el informe completo del experimento (vistas de arquitectura, tácticas, resultados, análisis, conclusión y decisión de arquitectura), con su fuente en LaTeX y las figuras |
